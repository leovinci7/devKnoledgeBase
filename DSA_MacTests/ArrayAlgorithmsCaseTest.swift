//
//  ArrayAlgorithmsCaseTest.swift
//  DSA_MacTests
//
//  Created by Medhad Ashraf Islam on 2/2/23.
//
...
final class ArrayAlgorithmsCaseTest: XCTestCase {
    ...
    func test_isSubSquence(){
       ...
       let arrayAlg = ArrayAlgorithms()
        ...
        for (_, pattern) in patternArray.enumerated(){
            patternReceivedResult.append(arrayAlg.isSubSquence(str: "helloworld", pattern: pattern))
        }
